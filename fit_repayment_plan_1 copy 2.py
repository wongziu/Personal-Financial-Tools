...
def fit_from_excel(
    ...
    if output_path is None:
        output_path = excel_path.with_name("测试数据结果-clear.xlsx")
...
def main() -> None:
    excel_path = Path("/Users/ziu.huang/Documents/GitHub/mortgage/还款计划验证数据 2026-03-12 22_01_14.xlsx")
